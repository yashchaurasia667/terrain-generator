...
vec3 perlinD(vec2 pos) {
  ...
  vec2 d00 = directions[pickGradient(p0.x, p0.y)];
  vec2 d01 = directions[pickGradient(p0.x, p1.y)];
  vec2 d10 = directions[pickGradient(p1.x, p0.y)];
  vec2 d11 = directions[pickGradient(p1.x, p1.y)];
